...
function Router(options) {
  ...
  this.__check_master_timer__ = Timer.setInterval(function () {
    self.__check_master__();
  }, UPDATE_INTERVAL);

  // Remove outdated lock records
  this.__locks_cleanup_timer__ = Timer.setInterval(function () {
...
Router.prototype.destroy = function () {
  ...
  Timer.clearInterval(this.__check_master_timer__);
  Timer.clearInterval(this.__locks_cleanup_timer__);
};
